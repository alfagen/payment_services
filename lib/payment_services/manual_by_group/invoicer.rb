...
class PaymentServices::ManualByGroup
  class Invoicer < ::PaymentServices::Base::Invoicer
    def prepare_invoice_and_get_wallet!(currency:, token_network:)
      wallet = income_payment_system.select_next_wallet!(income_payment_system.wallets_available_for_transfers.where(name_group: income_payment_system.wallets_name_group.presence))
